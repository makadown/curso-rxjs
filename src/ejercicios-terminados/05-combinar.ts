import { interval, timer, combineLatest, concat } from 'rxjs';
import { map, take, auditTime, debounceTime } from 'rxjs/operators';
/**
...
(() => {
    ...
    setTimeout(() => {
        combineLatest(letras$, numeros$).pipe(
            // map(([a, b]) => a + b) // destructuracion, asi tmb funciona
